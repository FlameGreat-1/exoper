  ...
  return (
    <div className="relative min-h-screen w-full bg-[#0a0a0f] overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-30">
        <div className="absolute top-0 left-1/4 w-72 h-72 sm:w-96 sm:h-96 bg-purple-600/20 rounded-full blur-[120px]" />
        <div className="absolute bottom-0 right-1/4 w-72 h-72 sm:w-96 sm:h-96 bg-blue-600/20 rounded-full blur-[120px]" />
      </div>
      ...
      <div className="relative z-10 flex flex-col items-center justify-start lg:pt-20 pt-12 pb-16 lg:pb-32 px-4 lg:px-6">
        ...
        {/* Globe Section */}
        <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-col items-center gap-8">
          {/* Text */}
          ...
          {/* Globe */}
          <div className="w-full flex justify-center items-center order-1 md:order-2 px-4 sm:px-6">
            <div className="relative w-[80vw] max-w-[400px] sm:max-w-[500px] md:max-w-[600px] aspect-square flex items-center justify-center">
              ...
              <div className="relative flex items-center justify-center w-full h-full">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 pointer-events-none z-20">
                  <img
                    ...
                    alt="Exoper"
                    className="w-20 h-20 sm:w-28 sm:h-28 md:w-32 md:h-32 lg:w-40 lg:h-40 object-contain drop-shadow-2xl"
                    style={{
