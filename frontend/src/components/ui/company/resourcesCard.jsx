    ...
    <div className="bg-[linear-gradient(180deg,#121421_0%,#0f1320_60%)]/95 backdrop-blur-xl p-4 rounded-2xl shadow-[0_6px_30px_rgba(2,6,23,0.6)] border border-[#222631] w-[500px]">
      <div className="grid grid-cols-3 gap-3">
        ...
        >
          ...
          <h3 className="text-white text-sm font-semibold mb-1">Partnerships</h3>
          <p className="text-gray-400 text-xs leading-relaxed">Collaborate with us</p>
        ...
        >
          ...
          <h3 className="text-white text-sm font-semibold mb-1">Docs</h3>
        ...
        >
          ...
          <h3 className="text-white text-sm font-semibold mb-1">Blogs</h3>
