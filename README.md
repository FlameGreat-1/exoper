...
const Services3 = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f] text-white overflow-hidden">
      ...
      IN DESKTOP SCREEN, THE TEXTS (WRITING) BELOW SHOULD GO UP A BIT.

IN MOBILE SCREENS THE TEXT SHOULD BE AT THE TOP WHILE THE SERVERS, THE PIPELINE CAPSULE AND WIRES SHOULD BE BELOW.

IN IN MOBILE SCREENS THE THE PIPELINE CAPSULE AND THE WIRE SHOULD GO DOWN MUCH TO AVOID CREATING EMPTY SPACES.

DO YOU UNDERSTAND WHAT I MEAN?

WE HAVE TO ENSURE EVERYTHING FOLLOWS INDUSTRY STANDARD, BEST PRATICE AND ENTERPRISE GRADE