      ...
      <div className="relative">
        ...
        >
          {allItems.map((tech, index) => (
            <div key={`${tech.name}-${index}`} className="flex-none flex flex-col items-center">
              <div className="w-16 h-16 flex items-center justify-center transform transition-transform hover:scale-110 duration-300">
                {tech.logo}
              </div>
