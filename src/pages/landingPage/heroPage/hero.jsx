...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 w-full max-w-7xl mx-auto px-4 sm:px-6 md:px-8 lg:px-12 flex flex-col items-center justify-start pt-12 sm:pt-16 md:pt-20 lg:pt-28 xl:pt-32 pb-8 md:pb-12 lg:pb-16">
        ...
        <motion.div 
          className="mt-8 sm:mt-10 md:mt-12 lg:mt-16 pt-6 sm:pt-8 md:pt-10 border-t border-gray-800 px-2 w-full flex flex-col items-center"
          initial={{ opacity: 0 }}
          animate={{ opacity: isVisible ? 1 : 0 }}
